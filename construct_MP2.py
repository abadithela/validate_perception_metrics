...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  9 10:00:49 2021

@author: apurvabadithela
"""
# Same as construct_MP.py but with proper handling for auxiliary variables
...
class synth_markov_chain:
    def __init__(self, S, O, state_to_S, obs_keys):
                ...
                for inp in input_comb:
                    ...
                    try: # Adding the environment state
                        ...
                        if self.K_int_state_map[Ki][state] is None:
                            ...
                            out_list = dict()
                            for ki in self.obs_keys[obs]:
                                out_list[ki] = out[ki]
                            self.K_int_state_map[Ki][state] = list(out_list.values()) # Updating state
